...
const es: WorkflowStoryContent = {
  meta: {
    sectionEyebrow: "",
    graphLabel: "LACE // GOVERNED WORKFLOW",
    graphTitle: "Runtime de ensamblaje de propuesta",
    runId: "run cf2a91b0",
  ...
  steps: [
    {
      id: "intro",
      eyebrow: "INTRO",
      title: "Modelado state-of-the-art",
      body:
        "LACE empieza con el conocimiento, las reglas, los documentos y los workflows que ya operan tu organización. Luego los convierte en AI applications gobernadas que pueden responder, actuar, redactar, revisar y producir trabajo con source grounding y control operativo.",
      progressStart: 0,
      progressEnd: 0.16
    },
    {
      id: "ingestion",
      eyebrow: "01 // Ingestion",
      title: "Ingestion - Construir tu enterprise knowledge base",
      body:
        "LACE ayuda a convertir tus materiales internos en una knowledge base lista para AI: policies, propuestas, reportes, manuales, financial decks, RFPs, standards, contratos, documentación de producto y registros operativos. En lugar de aplanarlo todo como texto genérico, LACE está diseñado para preservar la estructura que importa: secciones, tablas, charts, figuras, facts, claims y source relationships.",
      progressStart: 0.16,
      progressEnd: 0.32
    },
    {
      ...
      title: "Retrieval",
      body:
        "Cuando un usuario hace una pregunta o inicia un workflow, LACE no se limita a buscar un párrafo cercano. Busca la evidencia correcta. Eso puede significar encontrar un fact exacto en una tabla, extraer contexto de un source document, comparar reportes, grounding de una respuesta en un chart o figura, o reconocer cuándo hace falta una revisión corpus-wide más amplia.",
      progressStart: 0.32,
      progressEnd: 0.52
    },
    {
      ...
      title: "Workflow Planning",
      body:
        "LACE convierte la intención del usuario en un plan gobernado. La plataforma determina qué debe pasar, qué sources y tools son relevantes, qué policies aplican, qué nivel de confidence se requiere y dónde la revisión humana debe permanecer in the loop.",
      progressStart: 0.52,
      progressEnd: 0.68
    },
    {
      ...
      title: "Execution",
      body:
        "LACE ejecuta el trabajo mediante structured workflows que pueden combinar AI reasoning, retrieval, business logic, approved tools, document generation, artifact editing y human approvals. El resultado puede ser una respuesta, un documento revisado, una compliance review, una sección de propuesta, un reporte o un application workflow completo.",
      progressStart: 0.68,
      progressEnd: 0.84
    },
    {
      ...
      title: "Validation and Audit Trail",
      body:
        "LACE mantiene responsables los outputs de AI. Las sources pueden inspeccionarse, las citations pueden comprobarse, los cambios propuestos pueden revisarse antes de aplicarse y cada run deja una traza de lo que ocurrió. Los equipos obtienen la velocidad de AI con la auditability que exige el trabajo enterprise real.",
      progressStart: 0.84,
      progressEnd: 1
    }
  ],
  nodes: [
    {
      ...
      stepId: "intro",
      badge: "Model",
      title: "Modelar el contexto de negocio",
      detail: "Conocimiento, reglas, documentos y workflows se ensamblan en el operating frame que LACE gobernará.",
      footer: "business system mapped",
      runtime: "112ms",
      x: 192,
      y: 92,
    ...
    },
    {
      ...
      stepId: "ingestion",
      badge: "Ingest",
      title: "Construir knowledge base",
      detail: "Policies, propuestas, manuales, contratos, tablas, figuras y registros operativos se preservan con la estructura de source intacta.",
      footer: "enterprise corpus ready",
      runtime: "184ms",
      x: 54,
      y: 348,
    ...
    },
    {
      ...
      stepId: "retrieval",
      badge: "Retrieve",
      title: "Recuperar evidencia correcta",
      detail: "Facts exactos, source passages, tablas, charts y contexto cross-document se seleccionan para el workflow en curso.",
      footer: "grounded context pack",
      runtime: "612ms",
      x: 388,
      y: 618,
    ...
    },
    {
      ...
      stepId: "workflow-planning",
      badge: "Plan",
      title: "Planear ruta gobernada",
      detail: "Intent, sources, policy checks, confidence needs y human review points se compilan en una execution path controlada.",
      footer: "policy route selected",
      runtime: "96ms",
      x: 78,
      y: 900,
    ...
    },
    {
      ...
      detail: "AI reasoning, retrieval, business logic, approved tools, artifact edits y review gates corren como un solo proceso estructurado.",
      footer: "governed work in flight",
      runtime: "544ms",
      x: 388,
      y: 1168,
    ...
    },
    {
      ...
      stepId: "validation-audit",
      badge: "Validate",
      title: "Validar audit trail",
      detail: "Sources, citations, proposed changes, approvals y cada run event permanecen inspeccionables después de entregar el output.",
      footer: "trace retained",
      runtime: "196ms",
      x: 192,
      y: 1458,
